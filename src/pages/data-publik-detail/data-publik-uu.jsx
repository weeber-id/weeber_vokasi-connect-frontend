      ...
      <main>
        ...
        <section className="data-publik-table-section">
          <div className="data-publik-table-title">
            <h1 className="heading-primary text-align-center">UU IKM Vokasi</h1>
          </div>
          ...
          <div className="data-publik-container">
            <table className="data-publik-table">
              ...
              <tbody>
                <tr>
                  <td>UU AD IKM Universitas Indonesia</td>
                  <td>BEM Vokasi UI 2020</td>
                  <td>01/01/2020</td>
                  <td>download</td>
                </tr>
                <tr>
                  <td>UU AD IKM Vokasi Universitas Indonesia</td>
                  <td>BEM Vokasi UI 2020</td>
                  <td>01/01/2020</td>
                  <td>download</td>
                </tr>
                <tr>
                  <td>TAP DPM Vokasi</td>
                  <td>BEM Vokasi UI 2020</td>
                  <td>01/01/2020</td>
                  <td>download</td>
                </tr>
